...
[![made-with-R](https://img.shields.io/badge/Made%20with-R-ffd040.svg)](https://www.r-project.org/)
[![License:
MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://mit-license.org/)
[![GitHub
release](https://img.shields.io/github/v/release/jollygoodjacob/ShinyFPZ)](https://github.com/jollygoodjacob/ShinyFPZ/releases)
[![GitHub
...
using hydrogeomorphic variables obtained from the [OpenRES QGIS
plugin](https://github.com/jollygoodjacob/OpenRES). The app provides a
streamlined workflow for clustering river segments, visualizing results,
and exporting both analytical and spatial outputs.
...
context. **ShinyFPZ** enables users to:
...
classification generated by the OpenRES QGIS plugin. Example variables
often used include:
